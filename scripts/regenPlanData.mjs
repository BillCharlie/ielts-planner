...
const fullByDate = {
  "2026-07-26": ["C21T4", "C21T3"],
  "2026-07-27": ["C21T2", "C21T1"],
  "2026-07-29": ["C20T4"],
  "2026-07-30": ["C20T3"],
  "2026-07-31": ["C20T2"],
  "2026-08-01": ["C20T1"],
...
const payload = {
  ...
  source:
    "Planner v43: visible plan starts on 2026-07-26 from Cambridge 21 Test 4; 2026-07-26 and 2026-07-27 are two-full-mock days; 2026-07-28 has no plan",
  mainPlan,
  dailyTemplates,
  planVersion: "2026-07-26-start-c21t4-v43",
