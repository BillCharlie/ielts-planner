...
- **研究路线**：老师沟通节点、GaN FinFET 研究 Gate、台湾／HK／欧洲申请 Gate、月度总时间轴、IELTS、IEDMS / IWN 与 Plan A / B。
...
研究路线中的 Gate 以甘特图呈现：研究与申请分成上下两条泳道，共用 2026/09—2027/05 的完整月份刻度。条带表示准备／执行区间，末端菱形表示 Gate 截止点；HK 与欧洲的重叠申请期会在同一申请泳道中错层显示。月度总时间轴则使用纵向甘特图，让 2026/08—2027/12 从上往下推进，并以研究、IELTS／会议／论文、PhD 申请及 Plan A／B 四条泳道比较同月负荷。研究 Gate 追踪 Process、Device、Data 与 Thesis；申请 Gate 则依次追踪台湾本土博士、HK 与欧洲。台湾时间轴暂依上一届预留 10 月报名窗口，待 116 学年度正式简章公布后再校正；HK 采用 11 月中至 12 月底的内部窗口，欧洲从 12 月中准备并于 2027 年 1–3 月主投。老师推荐信分成 9 月台湾本土与 11 月 HK／欧洲两个阶段提出。
