...
研究路线中的 Gate 分为研究与申请上下两行，并共用同一条月份时间轴；没有 Gate 的月份保留空位，因此两条路线可以直接垂直比较。研究 Gate 追踪 Process、Device、Data 与 Thesis；申请 Gate 则依次追踪台湾本土博士、HK 与欧洲。台湾时间轴暂依上一届预留 10 月报名窗口，待 116 学年度正式简章公布后再校正；HK 采用 11 月中至 12 月底的内部窗口，欧洲从 12 月中准备并于 2027 年 1–3 月主投。老师推荐信分成 9 月台湾本土与 11 月 HK／欧洲两个阶段提出。
