...
完整真题范围为 Cambridge 9–21，共 52 份。考试日前的 48 个位置会排入 Cambridge 9–12 的 Test 1–3，以及 Cambridge 13–21 的 Test 1–4；第一份为 `C9T1`，最后一份为 `C21T4`，待排为 `C9T4`、`C10T4`、`C11T4`、`C12T4`。

## 本次资料重置

版本 `2026-08-16-cambridge-9-21-v5` 会在首次打开时自动：
