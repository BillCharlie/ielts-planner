...
研究路线中的 Gate 以甘特图呈现：研究与申请分成上下两条泳道，共用 2026/09—2027/05 的完整月份刻度。条带表示准备／执行区间，末端菱形表示 Gate 截止点；HK 与欧洲的重叠申请期会在同一申请泳道中错层显示。原研究任务看板已合并进月度纵向甘特图，2026/08—2027/12 从上往下推进，研究、IELTS／会议／论文、PhD 申请及 Plan A／B 四条泳道同时显示月度摘要和可勾选任务。IELTS／会议区不显示编号，左侧专门显示 IELTS，右侧专门显示已接受的 IEDMS／IWN 会议。研究 Gate 追踪 Process、Device、Data 与 Thesis；申请 Gate 则依次追踪台湾本土博士、HK 与欧洲。台湾时间轴暂依上一届预留 10 月报名窗口，待 116 学年度正式简章公布后再校正；HK 采用 11 月中至 12 月底的内部窗口，欧洲从 12 月中准备并于 2027 年 1–3 月主投。老师推荐信分成 9 月台湾本土与 11 月 HK／欧洲两个阶段提出。
